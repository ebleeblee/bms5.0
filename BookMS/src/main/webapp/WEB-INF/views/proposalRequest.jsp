...
<table cellspacing="0" border="0">
	...
	<tr>
		...
		<td align="left" valign=middle sdnum="1042;1042;General"><font color="#000000"><p>${proposalList.empName }</p> </font></td>
		<td align="left" valign=middle sdnum="1042;1042;General"><font color="#000000"><br></font></td>
		<td align="left" valign=middle sdnum="1042;1042;General"><font color="#000000"><br></font></td>
		<td align="left" valign=middle sdnum="1042;1042;General"><font color="#000000"><br></font></td>
		<td align="left" valign=middle sdnum="1042;1042;General"><font color="#000000"><br></font></td>
	...
	<%-- <c:if test="${bookCount} < '10'"> --%>
			...
			<tr align="center">
				...
				<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle sdnum="1042;1042;General"><font color="#000000">
         		...
         		<%-- <c:set var = "bookName" value = "${list.bookName}"/>
         		<c:choose>
         			<c:when test="${fn:length(list.bookName) > 11}">
         			
         			<%
         			String bookName = (String)pageContext.getAttribute("bookName") ;
         			byte [] strByte = bookName.getBytes();
         			String newBookName = new String( strByte, 0, 21 );
         			pageContext.setAttribute("newBookName", newBookName) ;
	         		%>
	         		<c:out value="${newBookName }"/>..
			...
			<%
					//int bookCount = Integer.parseInt(request.getParameter("bookCount"));
				String count = (String)request.getAttribute("bookCount");
	...
	<tr>
		<td colspan=4 rowspan=6 height="110" align="left" valign=middle sdnum="1042;1042;General" ><font color="#000000"><br><img src="${contextPath}/resources/eblee/img/proposal_img_01.png" width=314 height=125 hspace=31 vspace=11 style="border-style:solid; border-width:2px">
		</font></td>
		<td colspan=4 rowspan=6 align="left" valign=middle sdnum="1042;1042;General" ><font color="#000000"><br><img src="${contextPath}/resources/eblee/img/proposal_img_02.png" width=335 height=125 hspace=34 vspace=11 style="border-style:solid; border-width:2px">
		</font></td>
		</tr>
	<tr>
		</tr>
		...
		<tr>
		  <td colspan="15" rowspan="2">
		 	<div id="nonePrint">
					...
					<input type="button" class="btn btn-inverse pull-right" value="돌아가기" onclick="location.href='${contextPath }/proposalAdmin'">
				</div>
		</tr>
	</tfoot>	
</table>
