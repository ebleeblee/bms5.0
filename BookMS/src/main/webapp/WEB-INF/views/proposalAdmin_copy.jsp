	...
	<table class="table table-hover">
		<thead>
			...
			<tr align="center" style="font-weight: bold">
			    ...
			    <td><span><a href="${contextPath}/proposalAdmin?book_status=${book_status}&current_page=${pager.current_page}&sort_index=code&order_type=asc&dept=${select_dept}&max_rows=${pager.max_rows}">관리자</a></span></td>
				...
				<td><span><a href="${contextPath}/proposalAdmin?book_status=${book_status}&search=${search}&search_value=${search_value}&current_page=${pager.current_page}&sort_index=code&order_type=desc&dept=${select_dept}&max_rows=${pager.max_rows}">관리자</a></span></td>
				...
				<td><span><a href="${contextPath}/proposalAdmin?book_status=${book_status}&search=${search}&search_value=${search_value}&current_page=${pager.current_page}&sort_index=code&order_type=asc&dept=${select_dept}&max_rows=${pager.max_rows}">관리자</a></span></td>
